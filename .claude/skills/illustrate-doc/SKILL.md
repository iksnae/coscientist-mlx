...
| Hero image, story card, brand-aligned still | `.loswf/tools/generate_image.py` (`--prompt`) | ~$0.04–0.06 | Opening of a public-facing doc, devlog graphic, kickoff cover. DESIGN.md §9 brand voice auto-injects. |
